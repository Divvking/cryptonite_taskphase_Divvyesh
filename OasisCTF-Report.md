# OASIS CTF Report
Team Name: kryptos
Team Members: Divvyesh Ramesh, Tejas Bharathraj, Harsh Vardhan Keyal
CTF Style: Point System with levels

## Initial Levels:1-10
As the early levels of the CTF, they were more similar to the first 2 levels of cryptic hunts I used to participate in organised by various schools in the delhi tech circuit. These levels were rather straight-forward with single step solves.

## Special Mention: Level 9 - Keynough is enough
Cheeky mention of the Vigenere Key in the question itself. Boxentriq's bruteforce decoder for vigenere cipher failed due to the flag being in a different format than just alphabets.

## Level 11 - Key-Key, Do you love me?
This level required participants to interact with an LLM on discord. This problem ended up being slightly tricky, as it took some time to realise that the bot had no memory of the previous message, and did not make any fluent conversation. After attempting several ways to harm the kittens, including their recorded death count exceeding 100, the bot finally succumbed and gave the flag. 
